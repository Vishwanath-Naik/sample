...
<body>
  ...
  <div class="navbar">
     ...
     <div class="searches">
      <div class="srow">
      <input type="text" id="myInput2" class="myInput" onkeyup="myFunction2()" placeholder="Search for Punch Card Number.." title="Type in a name">
      ...
      <div class="per">
         ...
         <div class="polaroid" id="ccard">
                ...
                <p ><span class="name" id="pname"><?php echo $row['name']?><BR></span>
                    <span class="place"><?php echo $row['punchno']?><BR></span>
